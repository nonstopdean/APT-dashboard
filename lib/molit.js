...
// 카카오 REST API로 서버에서 직접 좌표를 검색한다 (JavaScript 키가 아니라 REST API 키 사용,
// 브라우저 없이 서버에서 미리 대량으로 좌표를 찾아둘 때 쓴다).
export async function geocodeViaKakaoRest(restApiKey, query) {
